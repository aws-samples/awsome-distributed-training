...
if __name__ == '__main__':
    ...
    parser.add_argument('--resize', default=False, type=utils.bool_flag, help="""if images should be resized""")
    ...
    parser.add_argument('--center_crop', default=None, type=int, help="""center crop factor to crop images""")
    parser.add_argument('--normalize', default=False, type=utils.bool_flag, help="""normalize with mean and std per channel""")
    ...
    parser.add_argument('--use_weighted_sampler', default=False, type=utils.bool_flag,help='Use weighted sampler for training.')
    ...
    parser.add_argument("--use_mean_patch_embedding", default=False, type=utils.bool_flag,help="Use mean patch embedding instead of first patch embedding")
    parser.add_argument("--use_custom_embedding_map", default=False, type=utils.bool_flag, help="Use custom embedding map")
    parser.add_argument("--custom_embedding_map", default=None, type=dict, help="Custom embedding map")
    parser.add_argument("--scDINO_full_pipeline", default=False, type=utils.bool_flag, help="Using scDINO full pipeline")
    ...
    # Added
    parser.add_argument('--images_are_RGB', default=False, type=utils.bool_flag)
    ...
    if dist.get_rank() == 0:
        ...
        if args.scDINO_full_pipeline:
            ...
            if not os.path.exists(cls_directory):
                os.makedirs(cls_directory)
