...
description: Monitor distributed training jobs and auto-restart on failure with checkpoint recovery. Tracks GPU utilization, EFA status, job progress, and provides comprehensive health reports.
license: MIT
compatibility: kiro
metadata:
  category: monitoring
