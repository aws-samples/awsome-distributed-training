...
from utils.train_utils_nvtx import (
    get_policies,
    get_profiler,
    setup,
    setup_environ_flags,
...
def parse_arge():
    ...
    parser.add_argument("--fsdp_activation_checkpointing", type=bool, default=False)
    ...
    parser.add_argument("--low_cpu_fsdp", type=bool, default=False)
