# This code is adopted from https://github.com/huggingface/transformers/blob/de11e654c962d5b23eb53a4387cd637b01987491/src/transformers/models/llama/convert_llama_weights_to_hf.py
