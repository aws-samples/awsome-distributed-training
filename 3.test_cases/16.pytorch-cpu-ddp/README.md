...
We will provide guide for both Slurm and Kubernetes but the conda example is only compatible with Slurm. Proceed to the subdirectory `slurm` or `kubernetes`. 
