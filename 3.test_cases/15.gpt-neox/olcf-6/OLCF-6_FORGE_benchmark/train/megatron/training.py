...
def train(
    ...
    while iteration < neox_args.train_iters:
        ...
        if neox_args.save and iteration in neox_args.save_iters:
            ...
            #import json
            #with open('/gpfs/alpine/scratch/junqi/stf218/crusher/gpt-neox-latest/megatron/tmp.json', 'r') as f: 
