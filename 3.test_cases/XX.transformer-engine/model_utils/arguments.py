...
def parse_args():  # pylint: disable=too-many-statements
    ...
    opt_grp.add_argument("--bf16", default=1, type=int, help="automatic mixed precision training with bf16")
    opt_grp.add_argument("--fp8", default=0, type=int, help="automatic mixed precision training with fp8")
    ...
    model_grp.add_argument("--vocab_size", type=int, default=32000)
    model_grp.add_argument("--hidden_width", type=int, default=4096)
    model_grp.add_argument("--num_layers", type=int, default=32)
    model_grp.add_argument("--num_heads", type=int, default=32)
