...
It is recommended that you use the templates in the architectures [directory](../../1.architectures) for AWS Parallel Cluster or Amazon SageMaker HyperPod Slurm set up.
...
Ensure this test case is placed under a shared filesystem such as `/fsx/` or the home directory. The following instructions assume you have cloned this repository under such a shared filesystem and changed your current directory to this directory.
