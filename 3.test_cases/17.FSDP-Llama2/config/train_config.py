...
class training_config:
    ...
    model_size: str = "7b"
    load_ckpt_path: str = "/fsx/llama2/ckpt"
    save_ckpt_path: str = "/fsx/llama2/ckpt" 

    dataset_path: str = "/fsx/data"
    seq_length: int = 4096
    sep_token: int = 1
    ...
    wandb_dir: str = "/fsx/wandb/llama-fsdp"
    wandb_project_name = f"llama-{model_size}"
